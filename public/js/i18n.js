...
const STR = {
  de: {
    ask: 'Fragen', close: 'Schließen', your_input: 'Dein Input…',
    ...
    system_prompt: 'System-Prompt', model: 'Modell', temperature: 'Temperatur',
    maxtokens: 'Max Tokens', api_base: 'API-Basis (leer = gleiche Origin)', language: 'Sprache'
  },
  en: {
    ask: 'Ask', close: 'Close', your_input: 'Your input…',
    ...
    system_prompt: 'System prompt', model: 'Model', temperature: 'Temperature',
    maxtokens: 'Max tokens', api_base: 'API base (empty = same origin)', language: 'Language'
  }
};
