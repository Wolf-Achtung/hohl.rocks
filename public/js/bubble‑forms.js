...
(() => {
  ...
  // ESC zum Schließen aller Formular-Popups. Ein globaler Listener
  // verhindert, dass Nutzer im Textfeld versehentlich stecken bleiben, ohne
  // das Popup mit der Maus schließen zu können.
  ...
  function openInputBubble(title, basePrompt = "", options = {}) {
    ...
    tools.className = "bf-tools";
    const bCopy = document.createElement("button");
    bCopy.className = "bf-btn";
    bCopy.textContent = "Kopieren";
    const bClose = document.createElement("button");
    bClose.className = "bf-btn";
    ...
    ta.placeholder =
      options?.placeholder || "Stichpunkte …";
