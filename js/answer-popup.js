/* answer-popup.js — Popup mit Kopieren & optional HTML-Inhalt */
(function(){
  function ensure(){ let p=document.getElementById('answer-popup'); if(p) return p;
    p=document.createElement('div'); p.id='answer-popup';
    Object.assign(p.style,{position:'fixed',left:'50%',top:'12%',transform:'translateX(-50%)',width:'min(920px,92vw)',maxHeight:'76vh',
